...
//    config_trigger("Button_1");
      ...
      config_entity("sensor","None","HumVelocity","Telemetry");
      config_entity("sensor","illuminance","Illuminance", "Telemetry");
...
//    delete_trigger("Button_1");
      ...
      delete_entity("sensor","None","HumVelocity","Telemetry");
      delete_entity("sensor","illuminance","Illuminance", "Telemetry");
}
