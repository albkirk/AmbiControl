...
#define SWVer               "05.05"                       // Major.Minor Software version (use String 01.00 - 99.99 format !)
...
#define LED_ESP              2                            // 8266=2, ESP32=22, ESP32C3=8, T-Call=13, TTGoTS=22, T5=19, -1 means NOT used!
...
#define BUT_A               13                            // Button A INPUT pin (used in buttons.h) TTGoTS=35, T5=39, TTGo T7=0
...
#define Default_ADC_PIN     A0                            // IO pin for Battery ADC measurement. Default->36,  TFT->36, EPaper->35
...
// -- I2C PIN Definition --
#define SDAPIN              12                            // 8266=4, ESP32=21, -1 means NO SDA used!
#define SCKPIN              14                            // 8266=5, ESP32=22, -1 means NO SCK used!
...
void config_defaults() {
    ...
    config.LDO_Corr = 0.58;                               // Battery Voltage [volt] corrective Factor due to LDO/Diode voltage drop
